...
$(document).ready(function(){
    var referralSubmit = document.querySelector('input[name="referral_submit_button"]'),
     ...
     blockSuc�ess = document.querySelector('.success-form-add'),
    ...
    btnOk.onclick= function() {
        ...
        blockSuc�ess.style.display = "none";
    ...
    referralSubmit.onclick = function() {
        ...
        var request = BX.ajax.runComponentAction('kit:auth.company.staff.register', 'sendReferralForm', {
            mode: 'class',
    ...
    registerSubmit.onclick = function() {
        ...
        var request = BX.ajax.runComponentAction('kit:auth.company.staff.register', 'sendForm', {
    ...
    confirmBtn.onclick = function() {
        ...
        var request = BX.ajax.runComponentAction('kit:auth.company.staff.register', 'confirmStaff', {
            signedParameters: window.arParams,
            mode: 'class',
            data: registerFormData
        });
    ...
    function showSuccessForm(obj, title) {
        let titleSuc�ess = document.querySelector('.success-form-add p');
        registerForm.reset();
        titleSuc�ess.innerHTML = title;
        obj.style.display = "none";
        blockSuc�ess.style.display = "block";
    }
