...
$hideSection["HIDDEN"] = GetMessage("NOT_SHOW");
$userGroups = $hideSection;
$rsGroups = CGroup::GetList ($by = "id", $order = "asc", Array ());
while($resGroups = $rsGroups->Fetch()) {
    $userGroups[$resGroups["ID"]] = $resGroups["NAME"];
}
...
$arComponentParameters = array(
	"PARAMETERS" => array(
		...
		"ABILITY_TO_SET_ROLE" => array(
            "NAME" => GetMessage("ABILITY_TO_SET_ROLE"),
            "TYPE" => "CHECKBOX",
            "DEFAULT" => "Y",
