...
function logInUser($userId) {
    var request = BX.ajax.runComponentAction('kit:company.staff.list', 'logInUser', {
        mode: 'class',
        data: {
            userId: $userId
        }
...
function removeUserCompany(userTableId, companyId) {
    var request = BX.ajax.runComponentAction('kit:auth.company.staff.list', 'removeUserCompany', {
        mode: 'class',
        data: {
...
function confirmUser(userTableId, companyId) {
    var request = BX.ajax.runComponentAction('kit:auth.company.staff.list', 'confirmUser', {
        mode: 'class',
        data: {
            userTableId: userTableId,
            companyId: companyId,
...
function unconfirmUser(userTableId, companyId) {
    var request = BX.ajax.runComponentAction('kit:auth.company.staff.list', 'unconfirmUser', {
        mode: 'class',
        data: {
            userTableId: userTableId,
            companyId: companyId,
...
function showAllUsers() {
    var request = BX.ajax.runComponentAction('kit:auth.company.staff.list', 'showAllUsers', {
        mode: 'class',
    });
