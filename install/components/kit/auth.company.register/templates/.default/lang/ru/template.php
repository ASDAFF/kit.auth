...
$MESS["REGISTER_CONFIDENTIAL"] = 'Я даю согласие на обработку персональных данных и соглашаюсь c <a href="'.\Bitrix\Main\Config\Option::get("kit.b2bcabinet", "CONFIDENTIAL_URL","/help/confidentiality/").'" target="_blank">политикой конфиденциальности</a>.';
$MESS["KIT_AUTH_GO_TO_WEBSITE"] = "Перейти на сайт";
