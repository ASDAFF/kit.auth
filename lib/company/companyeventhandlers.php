...
class CompanyEventHandlers extends \KitAuth
{
    ...
    public function setOrderPropertyValues(&$arResult, &$arUserResult, $arParams)
    {
        ...
        $requiredGroups = unserialize(Option::get(\KitAuth::idModule, "COMPANY_PROPS_GROUP_ID_" . $buerType, ""));
        $companyPropsName = unserialize(Option::get("kit.b2bcabinet", "PROFILE_ORG_NAME", "", SITE_ID));
    ...
    {
        return Option::get(\KitAuth::idModule, "EXTENDED_VERSION_COMPANIES", "N");
    }
    ...
    {
        return unserialize(Option::get(\KitAuth::idModule, $eventName, "", $siteId));
    }
