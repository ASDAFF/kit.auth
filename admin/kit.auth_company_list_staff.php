...
Loc::loadMessages(__DIR__.'/kit.auth_company_edit.php');
...
$POST_RIGHT = $APPLICATION->GetGroupRight(KitAuth::idModule);
if($POST_RIGHT === "D") {
...
$strSubElementAjaxPath = '/bitrix/admin/kit.auth_company_list_staff_ajax.php?ID='.$ID.'&lang='.LANGUAGE_ID;
...
$lAdmin->AddHeaders(
    [
        ...
        [
            "id"      => "NAME",
            "content" => Loc::getMessage(KitAuth::idModule."_EDIT_STAFF_NAME"),
            "default" => true,
        ],
        [
            "id"      => "EMAIL",
            "content" => Loc::getMessage(KitAuth::idModule."_EDIT_STAFF_EMAIL"),
            "default" => true,
        ],
        [
            "id"      => "ROLE",
            "content" => Loc::getMessage(KitAuth::idModule."_EDIT_STAFF_ROLE"),
            "default" => true,
        ],
        [
            "id"      => "GROUPS",
            "content" => Loc::getMessage(KitAuth::idModule."_EDIT_STAFF_GROUPS"),
            "default" => true,
        ],
        [
            "id"      => "COMPANY",
            "content" => Loc::getMessage(KitAuth::idModule."_EDIT_STAFF_COMPANY"),
            "default" => true,
        ],
        [
            "id"      => "STATUS",
            "content" => Loc::getMessage(KitAuth::idModule."_EDIT_STAFF_STATUS"),
            "default" => true,
        ],
    ]
);
...
while($arRes = $rsData->NavNext(true, "")) {
    ...
    foreach($getUserCompany as $currentCompany) {
        ...
        if(!empty($currentCompany) && !empty($companyList[$companyId])) {
            ...
            $viewUserCompany .= '<a href="kit.auth_company_edit.php?ID='.$companyId.'&lang='.LANGUAGE_ID.'">'
...
/*$lAdmin->AddGroupActionTable(
    [
        ...
        //"copy"=>Loc::getMessage(KitAuth::idModule."_LIST_COPY"),
...
$aContext = [
    [
        "TEXT"    => Loc::getMessage(KitAuth::idModule."_ADD_STAFF"),
        "LINK"    => "",
        "TITLE"   => Loc::getMessage(KitAuth::idModule."_ADD_STAFF"),
        "ICON"    => "btn_new",
        "ONCLICK" => "window.open('/bitrix/admin/user_search.php?lang=ru&FN=kit_auth_add_company_form&FC=STAFF', '', 'scrollbars=yes,resizable=yes,width=760,height=500,top='+Math.floor((screen.height - 560)/2-14)+',left='+Math.floor((screen.width - 760)/2-5));",
    ],
];
