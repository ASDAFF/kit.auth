...
class Mail extends \SotbitAuth
{
	...
	{
		if($this->getField('NEW_TEXT') && Option::get( self::idModule, 'AUTH_FROM_EMAIL_DOMAIN', '', $this->getField('LID')) && Option::get( self::idModule, 'AUTH_STATISTICS', 'Y', $this->getField('LID') ) == 'Y')
		{
        $arFilter = Array(
        ...
        $insert = array(
            ...
            'ID_USER' => $this->User()->getField( 'ID' ),
            'EVENT_NAME'=>$this->getField('EVENT_NAME'),
            'EVENT_TEMPLATE'=>$messageTempalte
        );
