...
elseif (isset($_REQUEST['update'])){
    ...
    $arCurrentValues["CONFIRM_REGISTER"] = Option::get( SotbitAuth::idModule, "CONFIRM_REGISTER", "",$site_id );
}
...
{
	$arCurrentValues["WHOLESALERS_PERSON_TYPE"] = unserialize(Option::get( SotbitAuth::idModule, "WHOLESALERS_PERSON_TYPE", "",$site_id ));
}
...
{
	$CurrentValueOrderFields= unserialize( Option::get( SotbitAuth::idModule, 'WHOLESALERS_ORDER_FIELDS', 'a:0:{}',$site_id ) );
}
...
$arTabs = array(
        ...
        array(
                'DIV' => 'mail_events',
                'TAB' => Loc::getMessage( SotbitAuth::idModule . '_mail_events' ),
                'ICON' => '',
                'TITLE' => Loc::getMessage( SotbitAuth::idModule . '_mail_events' ),
                'SORT' => '30'
        )
);
$arGroups = array(
        ...
        'GROUP_SETTINGS_MAIL_EVENTS' => array(
                'TITLE' => Loc::getMessage( SotbitAuth::idModule . '_GROUP_SETTINGS_MAIL_EVENTS' ),
                'TAB' => 2
        ),
...
$arOptions = array(
        ...
        'MAIL_EVENT_COMPANY_REGISTER' => array(
            ...
            'TITLE' => Loc::getMessage( SotbitAuth::idModule . '_MAIL_EVENT_COMPANY_REGISTER' ),
            'TYPE' => 'MSELECT',
            'REFRESH' => 'N',
            'SORT' => '1',
            'VALUES' => $events,
        ...
        'MAIL_EVENT_COMPANY_SENT_MODERATION' => array(
            'GROUP' => 'GROUP_SETTINGS_MAIL_EVENTS',
            'TITLE' => Loc::getMessage( SotbitAuth::idModule . '_MAIL_EVENT_COMPANY_SENT_MODERATION' ),
            'TYPE' => 'MSELECT',
            'REFRESH' => 'N',
            'SORT' => '1',
            'VALUES' => $events,
        ...
        'MAIL_EVENT_COMPANY_CONFIRM' => array(
            'GROUP' => 'GROUP_SETTINGS_MAIL_EVENTS',
            'TITLE' => Loc::getMessage( SotbitAuth::idModule . '_MAIL_EVENT_COMPANY_CONFIRM' ),
            'TYPE' => 'MSELECT',
            'REFRESH' => 'N',
            'SORT' => '5',
            'VALUES' => $events,
        ...
        'MAIL_EVENT_COMPANY_REJECTED' => array(
            'GROUP' => 'GROUP_SETTINGS_MAIL_EVENTS',
            'TITLE' => Loc::getMessage( SotbitAuth::idModule . '_MAIL_EVENT_COMPANY_REJECTED' ),
            'TYPE' => 'MSELECT',
            'REFRESH' => 'N',
            'SORT' => '10',
            'VALUES' => $events,
        ...
        'MAIL_EVENT_COMPANY_ADMIN_CONFIRM' => array(
            'GROUP' => 'GROUP_SETTINGS_MAIL_EVENTS',
            'TITLE' => Loc::getMessage( SotbitAuth::idModule . '_MAIL_EVENT_COMPANY_ADMIN_CONFIRM' ),
            'TYPE' => 'MSELECT',
            'REFRESH' => 'N',
            'SORT' => '15',
            'VALUES' => $events,
        ...
        'MAIL_EVENT_COMPANY_ADMIN_REJECTED' => array(
            'GROUP' => 'GROUP_SETTINGS_MAIL_EVENTS',
            'TITLE' => Loc::getMessage( SotbitAuth::idModule . '_MAIL_EVENT_COMPANY_ADMIN_REJECTED' ),
            'TYPE' => 'MSELECT',
            'REFRESH' => 'N',
            'SORT' => '20',
            'VALUES' => $events,
        ...
        'MAIL_EVENT_COMPANY_CHANGES_REJECTED' => array(
            'GROUP' => 'GROUP_SETTINGS_MAIL_EVENTS',
            'TITLE' => Loc::getMessage( SotbitAuth::idModule . '_MAIL_EVENT_COMPANY_CHANGES_REJECTED' ),
            'TYPE' => 'MSELECT',
            'REFRESH' => 'N',
            'SORT' => '25',
            'VALUES' => $events,
        ...
        'MAIL_EVENT_COMPANY_STAFF_INVITE' => array(
            'GROUP' => 'GROUP_SETTINGS_MAIL_EVENTS',
            'TITLE' => Loc::getMessage( SotbitAuth::idModule . '_MAIL_EVENT_COMPANY_STAFF_INVITE' ),
            'TYPE' => 'MSELECT',
            'REFRESH' => 'N',
            'SORT' => '30',
            'VALUES' => $events,
        ...
        'MAIL_EVENT_COMPANY_JOIN_REQUEST' => array(
            'GROUP' => 'GROUP_SETTINGS_MAIL_EVENTS',
            'TITLE' => Loc::getMessage( SotbitAuth::idModule . '_MAIL_EVENT_COMPANY_JOIN_REQUEST' ),
            'TYPE' => 'MSELECT',
            'REFRESH' => 'N',
            'SORT' => '35',
            'VALUES' => $events,
        ...
        'MAIL_EVENT_COMPANY_JOIN_REQUEST_CONFIRM' => array(
            'GROUP' => 'GROUP_SETTINGS_MAIL_EVENTS',
            'TITLE' => Loc::getMessage( SotbitAuth::idModule . '_MAIL_EVENT_COMPANY_JOIN_REQUEST_CONFIRM' ),
            'TYPE' => 'MSELECT',
            'REFRESH' => 'N',
            'SORT' => '40',
            'VALUES' => $events,
        ...
        'MAIL_EVENT_COMPANY_JOIN_REQUEST_REJECTED' => array(
            'GROUP' => 'GROUP_SETTINGS_MAIL_EVENTS',
            'TITLE' => Loc::getMessage( SotbitAuth::idModule . '_MAIL_EVENT_COMPANY_JOIN_REQUEST_REJECTED' ),
            'TYPE' => 'MSELECT',
            'REFRESH' => 'N',
            'SORT' => '45',
            'VALUES' => $events,
        ...
        'MAIL_EVENT_COMPANY_STAFF_REMOVED' => array(
            'GROUP' => 'GROUP_SETTINGS_MAIL_EVENTS',
            'TITLE' => Loc::getMessage( SotbitAuth::idModule . '_MAIL_EVENT_COMPANY_STAFF_REMOVED' ),
            'TYPE' => 'MSELECT',
            'REFRESH' => 'N',
            'SORT' => '50',
            'VALUES' => $events,
...
if($arCurrentValues["CONFIRM_REGISTER"] == "Y" && Option::get( SotbitAuth::idModule, "EXTENDED_VERSION_COMPANIES", "N")=="Y"){

    $dbRoles = Sotbit\Auth\Company\Company::getRoles();
    ...
    $arOptions["COMPANY_STAFF_ROLE"] = [
        'GROUP' => 'GROUP_SETTINGS_WHOLESALERS',
        'TITLE' => Loc::getMessage( SotbitAuth::idModule . '_COMPANY_STAFF_ROLE' ),
        'TYPE' => 'MSELECT',
        'REFRESH' => 'N',
        'SORT' => '225',
        'SITE' => $site_id,
        'VALUES' => $staffRoles,
        'NOTES' => Loc::getMessage( SotbitAuth::idModule . '_COMPANY_STAFF_ROLE_NOTES' )
    ];
}
...
if(!$_REQUEST['site']) {
    ...
    $arOptions['EXTENDED_VERSION_COMPANIES'] = array(
        'GROUP' => 'GROUP_SETTINGS',
        'TITLE' => Loc::getMessage( SotbitAuth::idModule . '_EXTENDED_VERSION_COMPANIES' ),
        'TYPE' => 'CHECKBOX',
        'REFRESH' => 'Y',
        'SORT' => '10',
        'DEFAULT' => 'N',
        'NOTES' => Loc::getMessage( SotbitAuth::idModule . '_EXTENDED_VERSION_COMPANIES_NOTES' )
    );
}
...
foreach ($personTypeCurrent as $key=>$personTypeA)
{
    ...
    $groupFields = unserialize(Option::get(SotbitAuth::idModule, 'GROUP_FIELDS_' . $personTypeA['ID'] , '', $site_id));
    ...
    while ($propsGroup = $dbPropsGroup->Fetch())
    {
        ...
        if($propsGroup["NAME"] == Loc::getMessage( SotbitAuth::idModule . '_GROUP_COMPANY_IP_DATA' ) ||
            $propsGroup["NAME"] == Loc::getMessage( SotbitAuth::idModule . '_GROUP_COMPANY_UR_DATA' )
        ) {
    ...
    if(Option::get(SotbitAuth::idModule, "EXTENDED_VERSION_COMPANIES", 'N') == "Y"){
        $arOptions['GROUP_FIELDS_FOR_CHECK_'.$personTypeA['ID']] = array(
            'GROUP' => 'GROUP_SETTINGS_' . $countGroups,
            'TITLE' => Loc::getMessage( SotbitAuth::idModule . '_GROUP_FIELDS_FOR_CHECK' ),
            'TYPE' => 'MSELECT',
            'REFRESH' => 'N',
            'SORT' => '60',
            'SIZE' => '10',
            'SITE' => $site_id,
            'VALUES' => $orderFields,
            'NOTES' => Loc::getMessage( SotbitAuth::idModule . '_GROUP_FIELDS_FOR_CHECK_NOTES' )
        );

        $arOptions['COMPANY_PROPS_GROUP_ID_'.$personTypeA['ID']] = array(
            'GROUP' => 'GROUP_SETTINGS_' . $countGroups,
            'TITLE' => Loc::getMessage( SotbitAuth::idModule . '_COMPANY_PROPS_GROUP_ID' ),
            'TYPE' => 'MSELECT',
            'REFRESH' => 'N',
            'SORT' => '70',
            'SIZE' => '10',
        ...
        $arOptions['COMPANY_PROPS_NAME_FIELD_'.$personTypeA['ID']] = array(
            'GROUP' => 'GROUP_SETTINGS_' . $countGroups,
            'TITLE' => Loc::getMessage( SotbitAuth::idModule . '_COMPANY_PROPS_NAME_FIELD' ),
            'TYPE' => 'SELECT',
            'REFRESH' => 'N',
            'SORT' => '70',
            'SIZE' => '10',
...
if( $RIGHT != "D" )
{
	...
	$showRightsTab = false;
	$opt = new \Sotbit\Auth\Option( SotbitAuth::idModule, $site_id, $arTabs, $arGroups, $arOptions, $showRightsTab );
	$opt->ShowHTML();
}
$APPLICATION->SetTitle( Loc::getMessage( SotbitAuth::idModule . '_TITLE' ) );
require (Application::getDocumentRoot() . "/bitrix/modules/main/include/epilog_admin.php");
