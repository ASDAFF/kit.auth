...
?>
<div class="sotbit-auth__file-input">
    <? if ($arParams["ALLOW_UPLOAD"] != "N") { ?>
        ...
        <div id="file-selectdialog-<?= $uid ?>" class="file-selectdialog1 form-group file-area" style="display:none;">
            ...
            <div class="file-extended file-dummy">
                ...
                <div class="file-selector card-title">

                    <span><?= GetMessage('BFDND_DROPHERE'); ?><?= GetMessage('BFDND_SELECT_EXIST'); ?></span>

                    <span class="file-uploader">
                         <label class="file-uploader-label">
                        <input class="file-fileUploader <?= $addClass ?>" id="file-fileUploader-<?= $uid ?>" type="file"
                               multiple='multiple' size='1' style="display: none"/>
                             <span class="add-file-button"><?= GetMessage('BFDND_ADD'); ?></span>
                         </label>
                    </span>
                </div>
            </div>
