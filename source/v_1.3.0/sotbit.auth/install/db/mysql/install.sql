...
CREATE TABLE IF NOT EXISTS `sotbit_auth_company` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `sotbit_auth_company_props_value` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `sotbit_auth_roles` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `CODE` varchar(255) NOT NULL,
  `NAME` varchar(500) NULL,
  PRIMARY KEY (`ID`)
);
CREATE TABLE IF NOT EXISTS `sotbit_auth_staff` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `sotbit_auth_company_confirm` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `ID_USER` int(11) NULL,
  `LID` char(2) NOT NULL,
  `FIELDS` text NULL,
